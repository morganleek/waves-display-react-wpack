...
module.exports = {
	// Project Identity
	appName: 'wavesDisplayReactWpack', // Unique name of your project
	type: 'plugin', // Plugin or theme
	slug: 'waves-display-react-wpack', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	// Used to generate banners on top of compiled stuff
	bannerConfig: {
		name: 'wavesDisplayReactWpack',
		author: '',
		license: 'UNLICENSED',
		link: 'UNLICENSED',
		version: pkg.version,
		...
		// If this has length === 1, then single compiler
		{
			...
			entry: {
		     ...
		     // global namespace pollutions 😉
				main: ['./src/js/index.js'], // Or an array of string (string[])
			},
